...
class Contest(Base):
    ...
    contest_submissions: Mapped[List['ContestSubmission']] = relationship('ContestSubmission', back_populates='contest', cascade='all, delete-orphan', passive_deletes=True)